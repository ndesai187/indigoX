...
public class ViewScanCodesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_scan_codes);
        ...
        cursorAdapter = new SimpleCursorAdapter(this, R.layout.content_view_scan_codes
                ,cursor,from,to, 0);
